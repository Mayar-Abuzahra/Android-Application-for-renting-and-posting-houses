...
public final class ActivitySearchGuestBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySearchGuestBinding(@NonNull FrameLayout rootView, @NonNull CheckBox balcony,
  ...
  @NonNull
  public static ActivitySearchGuestBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySearchGuestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_search_guest, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySearchGuestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySearchGuestBinding((FrameLayout) rootView, balcony, button9, checkBox,
