...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  private FragmentHistoryBinding(@NonNull FrameLayout rootView, @NonNull ScrollView sv2) {
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.sv2;
      ScrollView sv2 = ViewBindings.findChildViewById(rootView, id);
      if (sv2 == null) {
        break missingId;
      }

      return new FragmentHistoryBinding((FrameLayout) rootView, sv2);
    }
